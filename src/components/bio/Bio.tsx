          ...
          <Col xs={24} sm={24} md={16} lg={16} xl={16}>
            <div className="Bio-text">
              <p>
                ...
                both the back and front end, while using a modern tech stack to
                make things go: <i>Beep-Boop</i>.
              </p>
              <p>
                ...
                Stack development presented itself I was over the moon, and as a
                result, these days I'm a full-blown Stack Developer. More
                recently, at a professional level, I’ve been working with
                Typescript on the backend side of things, and with React on the
                front-end bits -{" "}
                <a

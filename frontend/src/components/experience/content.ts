export default [
  {
    ...
    roles: [
      ...
      "Responsible for improving Longshot’s Authentication and Authorization procedures and tooling. In particular, evaluation what OpenID Connect system could to jointly solve internal and external use-cases. This involved developing PoCs (that represented how each tool would fit with the rest of our architecture), analyzing the pros and cons of each solution and, eventually, presenting the findings to the wider-team. Lastly, was also responsible for overseeing the introducing of the selected system into production.",
    ],
